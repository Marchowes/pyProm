...
class Saddle(SpotElevation):
    ...
    #     """
    #
    #     # Gather all shortest paths.
    #     full_shortest_paths = self.find_shortest_paths_between_high_shores()
    #     # Index for keeping track of explored nodes.
    #     explored_nodes_index = dict()
    #     # This is what we're really after, a list of all the shortest links.
    #     shortest_links = list()
    #     # Seed our toBeExplored list
    #     toBeExplored = [full_shortest_paths[0]]
    ...
    #                 shortest_links.append(shortest)
    ...
    #                     starting_point = node
    #             shortest_links.append(shortest_link)
    #             toBeExplored.append(starting_point)
    #         # Everyone explored? GTFO.
    #         else:
    #             break
    #     # All done? return list of Vertex Links.
    #     return shortest_links
    #
    # def generate_child_saddles(self, datamap):
    #     """
    ...
    #     of highShores in `self` These saddles. have their highShores
    ...
    #     shortest_links = self.build_internal_tree()
    #     saddles = list()
    ...
    #                                 self.elevation)
    #         middleSpotElevation = middlePoint.toSpotElevation(datamap)
    ...
    #         if self.edgeEffect:
    #             newSaddle.parent = self
    #             self.children.append(newSaddle)
    ...
    #     index = nesteddict()
    #     totalShores = len(self.highShores)
    ...
    #                 self.highShores[outerIdx].findClosestPoints(
    #                     self.highShores[innerIdx])
    ...
    #     # build out our final list ordered by index position of the highShores
    #     allVertexLinkers = list()
    #     # create X empty :class:`Feature_Verticies`
    #     for idx in range(len(self.highShores)):
    #         allVertexLinkers.append(Feature_Verticies(idx, []))
    ...
    #             allVertexLinkers[idx].vertex_linkers.append(
    #                 Vertex_Link(data[0],
    #                             data[1],
    #                             data[2],
    #                             allVertexLinkers[remoteNodeIdx]))
    #     return allVertexLinkers
